...
const Contact = () => {
  ...
  return (
    <section className="relative flex w-full flex-col pb-[20vh] min-[1024px]:min-h-[85vh] max-[600px]:pb-[15vh] max-[480px]:pb-[12vh]" id="contact">
      ...
      <motion.div
        className="grid w-full grid-cols-2 gap-6 pt-[6vh] max-lg:grid-cols-1 max-lg:pt-[4vh]"
      ...
      >
        {/* Contact Info */}
        <motion.div className="flex flex-col gap-5 px-5 py-5 transition-all duration-300" variants={itemFadeUp}>
          <h2 className="text-[1.5rem] font-semibold text-[#4F4D4D]">Get In Touch</h2>

          <div className="flex flex-col gap-4">
            {contactItems.map((item) => (
              <motion.div key={item.title} className="rounded-lg px-4 py-4" variants={itemFadeUp} whileHover={{ x: 4 }}>
